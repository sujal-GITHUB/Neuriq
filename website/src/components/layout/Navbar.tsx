...
export default function Navbar() {
  ...
  // logo1.png is for light mode, logo2.png is for dark mode
  const currentLogo = mounted && resolvedTheme === "dark" ? "/logo2.png" : "/logo1.png"
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto px-6 h-full">
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity">
            ...
            />
            <span className="text-sm font-semibold text-foreground">Neuriq</span>
          </Link>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/analyze?reset=true" className="hidden md:block">
